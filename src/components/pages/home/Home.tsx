  ...
  return (
    <>
      <section className="overflow-hidde l relative bg-white py-16 lg:py-40">
        <div className="animate-gradient absolute inset-0 bg-white bg-[radial-gradient(circle_at_top_left,#06b6d4_0%,transparent_30%),radial-gradient(circle_at_bottom_right,#8b5cf6_0%,transparent_35%),radial-gradient(circle_at_center,#2563eb_0%,transparent_40%),linear-gradient(135deg,#020617_0%,#000000_45%,#0f172a_100%)] bg-[length:300%_300%]" />
